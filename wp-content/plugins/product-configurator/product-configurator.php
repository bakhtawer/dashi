...
class ProductConfigurator {
    ...
    public function enqueue_assets() {
        if (is_product()) {
            wp_enqueue_script('pconf-js', plugin_dir_url(__FILE__) . 'assets/config.js',['jquery'],'1.0.1',true);
    ...
    public function ajax_calculate_price() {
        $product_id =intval($_POST['product_id']??0);//  sentization added - code have been fixed
